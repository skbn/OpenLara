...
void initSettings()
{
    ...
    gSettings.audio_sfx = 16;
    gSettings.audio_music = 16;
    gSettings.video_gamma = 0;
    gSettings.video_fps = 1;
    gSettings.video_vsync = 0;
    gSettings.audio_language = 0;
    gSettings.audio_subtitles = 1;
    gSettings.audio_backend = SND_BACKEND_AUTO;
    gSettings.audio_stereo = 0;
    gSettings.audio_freq = 0;
    gSettings.video_mode = VMODE_32;
    gSettings.video_quant = 0;
    gSettings.video_filter = 0;
    gSettings.video_monitor = VMON_AUTO;

    osLoadSettings();

    gSettings.audio_sfx = X_MIN(gSettings.audio_sfx, 16);
    gSettings.audio_music = X_MIN(gSettings.audio_music, 16);
    gSettings.video_gamma = X_MIN(gSettings.video_gamma, 16);
    gSettings.audio_language = X_MIN(gSettings.audio_language, LANG_COUNT - 1);
    gSettings.audio_backend = X_MIN(gSettings.audio_backend, SND_BACKEND_AHI);
    gSettings.audio_stereo &= 1;
    gSettings.audio_freq = X_MIN(gSettings.audio_freq, 2);
    gSettings.video_mode = X_MIN(gSettings.video_mode, VMODE_MAX - 1);
    gSettings.video_quant &= 1;
    gSettings.video_filter &= 1;
    gSettings.video_monitor = X_MIN(gSettings.video_monitor, VMON_MAX - 1);
}
...
void gameInit()
{
    ...
    ensureLanguage(gSettings.audio_language);
