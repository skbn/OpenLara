...
extern uint8 origLightmap[256 * 32];
extern uint8 gFillmapData[256 * 32];
extern uint8 *gFillmap;
extern uint8 gInvQuant[256];
extern uint8 lightmapNeedsSave;
...
#define ecsbuildFillmap ecsbuildFillmap_asm
#else
#define ecsBuildRemap ecsBuildRemap_c
#define ecsRemapLightmap ecsRemapLightmap_c
#define ecsbuildFillmap ecsbuildFillmap_c
#endif
